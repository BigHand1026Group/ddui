...
(function () {
  ...
  // QRCode object
  QRCode = function (canvasId, vOption, thisWindow) {
    this._htOption = {
      top:0,
      left:0,
      width: 256,
    ...
    if (this._htOption.text && this.canvasId) {
      this.makeCode(this._htOption.text, thisWindow);
    }
  };

  QRCode.prototype.makeCode = function (sText, thisWindow) {
    this._oQRCode = new QRCodeModel(_getTypeNumber(sText, this._htOption.correctLevel), this._htOption.correctLevel);
    this._oQRCode.addData(sText);
    this._oQRCode.make();
    this.makeImage(thisWindow);
  };

  QRCode.prototype.makeImage = function (thisWindow) {
    var _oContext = wx.createCanvasContext(this.canvasId, thisWindow)
    ...
    for (var row = 0; row < nCount; row++) {
      for (var col = 0; col < nCount; col++) {
        ...
        // if (bIsDark) {
        _oContext.setShadow(0, 0, 0, 'white')
